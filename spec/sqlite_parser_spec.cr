...
describe "SQLite data pipeline" do
  it "writes and reads dataset using sqlite3" do
    ...
    data_section = {} of String => SheetParser::JsonValue
    ...
    data_section["Cores"] = [core].as(SheetParser::JsonValue)
    data_section["Magazines"] = [mag].as(SheetParser::JsonValue)
    data_section["Barrels"] = [part].as(SheetParser::JsonValue)
    data_section["Grips"] = [part].as(SheetParser::JsonValue)
    data_section["Stocks"] = [part].as(SheetParser::JsonValue)
    ...
    data = {} of String => SheetParser::JsonValue
    data["Data"] = data_section
    data["Penalties"] = [[1.0]]
    data["Categories"] = categories

    begin
      SheetParser.save_sqlite(data, db_path)
